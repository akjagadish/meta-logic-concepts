...
# LSTM prior-trained
first_array = np.load('lstm_ans_arrays_simpleboolean/first_array.npy')
second_array = np.load('lstm_ans_arrays_simpleboolean/second_array.npy')
third_array = np.load('lstm_ans_arrays_simpleboolean/third_array.npy')
last_array = np.load('lstm_ans_arrays_simpleboolean/last_array.npy')

# Transformer prior-trained
transformer_first_array = np.load('transformer_ans_arrays_simpleboolean/first_array.npy')
transformer_second_array = np.load('transformer_ans_arrays_simpleboolean/second_array.npy')
transformer_third_array = np.load('transformer_ans_arrays_simpleboolean/third_array.npy')
transformer_last_array = np.load('transformer_ans_arrays_simpleboolean/last_array.npy')

# MLP prior-trained
mlp_first_array = np.load('mlp_ans_arrays_simpleboolean/first_array.npy')
mlp_second_array = np.load('mlp_ans_arrays_simpleboolean/second_array.npy')
mlp_third_array = np.load('mlp_ans_arrays_simpleboolean/third_array.npy')
mlp_last_array = np.load('mlp_ans_arrays_simpleboolean/last_array.npy')
...
# Transformer random
transformer_random_first_array = np.load('transformer_ans_arrays_simpleboolean/random_first_array.npy')
transformer_random_second_array = np.load('transformer_ans_arrays_simpleboolean/random_second_array.npy')
transformer_random_third_array = np.load('transformer_ans_arrays_simpleboolean/random_third_array.npy')
transformer_random_last_array = np.load('transformer_ans_arrays_simpleboolean/random_last_array.npy')

# MLP random
mlp_random_first_array = np.load('mlp_ans_arrays_simpleboolean/random_first_array.npy')
mlp_random_second_array = np.load('mlp_ans_arrays_simpleboolean/random_second_array.npy')
mlp_random_third_array = np.load('mlp_ans_arrays_simpleboolean/random_third_array.npy')
mlp_random_last_array = np.load('mlp_ans_arrays_simpleboolean/random_last_array.npy')
...
plt.plot(x, prior_trained, marker='o', label='SimpleBoolean Prior-trained', color='tab:orange', linestyle='solid' ,markersize=10)
...
plt.savefig('new_plots/avg_all_concepts')
plt.show()
...
print('Standard:', standard)
print('Human:', human)
print("\nR² values for all concepts:")
print(f'R² LSTM Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(prior_trained)/100):.4f}')
print(f'R² Standard vs Human: {r2_score(np.array(human)/100, np.array(standard)/100):.4f}')
...
print('Human:', human)
print("\nR² values for all concepts (architectures comparison):")
print(f'R² LSTM Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(prior_trained)/100):.4f}')
print(f'R² Transformer Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(transformer_prior_trained)/100):.4f}')
print(f'R² MLP Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(mlp_prior_trained)/100):.4f}')

plt.figure(figsize=(10, 8))

plt.plot(x, prior_trained, marker='o', label='LSTM', color='tab:orange', linestyle='solid', markersize=10)
plt.plot(x, transformer_prior_trained, marker='>', label='Transformer', color='tab:orange', linestyle='solid', markersize=10)
plt.plot(x, mlp_prior_trained, marker='<', label='MLP', color='tab:orange', linestyle='solid', markersize=10)
plt.plot(x, human, marker='s', label='Human', color='tab:green', linestyle='solid', markersize=10)
plt.xlim(20, 105)
plt.ylim(50, 105)
plt.xticks(x, fontsize=20)
...
plt.legend(fontsize=20, loc='upper left')
plt.savefig('new_plots/architectures_priortrained_all_concepts.png')
plt.show()
...
print('Human:', human)
print("\nR² values for all concepts (standard architectures):")
print(f'R² LSTM Standard vs Human: {r2_score(np.array(human)/100, np.array(standard)/100):.4f}')
print(f'R² Transformer Standard vs Human: {r2_score(np.array(human)/100, np.array(transformer_standard)/100):.4f}')
print(f'R² MLP Standard vs Human: {r2_score(np.array(human)/100, np.array(mlp_standard)/100):.4f}')
...
plt.legend(fontsize=20, loc='upper left')
plt.savefig('new_plots/architectures_standard_all_concepts.png')
plt.show()
...
print('Standard:', standard)
print('Human:', human)
print("\nR² values for SimpleBoolean concepts:")
print(f'R² LSTM Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(prior_trained)/100):.4f}')
print(f'R² Standard vs Human: {r2_score(np.array(human)/100, np.array(standard)/100):.4f}')
...
print('MLP Prior-trained:', mlp_prior_trained)
print('Human:', human)
print("\nR² values for SimpleBoolean concepts (architectures comparison):")
print(f'R² LSTM Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(prior_trained)/100):.4f}')
print(f'R² Transformer Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(transformer_prior_trained)/100):.4f}')
print(f'R² MLP Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(mlp_prior_trained)/100):.4f}')
...
plt.savefig('new_plots/avg_simpleboolean_concepts')
plt.show()
...
# plt.legend(fontsize=16, loc='upper left')
plt.savefig('new_plots/architectures_priortrained_simpleboolean_concepts.png')
plt.show()
...
print('MLP Standard:', mlp_standard)
print('Human:', human)
print("\nR² values for SimpleBoolean concepts (standard architectures):")
print(f'R² LSTM Standard vs Human: {r2_score(np.array(human)/100, np.array(standard)/100):.4f}')
print(f'R² Transformer Standard vs Human: {r2_score(np.array(human)/100, np.array(transformer_standard)/100):.4f}')
print(f'R² MLP Standard vs Human: {r2_score(np.array(human)/100, np.array(mlp_standard)/100):.4f}')
...
# plt.legend(fontsize=16, loc='upper left')
plt.savefig('new_plots/architectures_standard_simpleboolean_concepts.png')
plt.show()
...
print('Standard:', standard)
print('Human:', human)
print("\nR² values for NOT SimpleBoolean concepts:")
print(f'R² LSTM Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(prior_trained)/100):.4f}')
print(f'R² Standard vs Human: {r2_score(np.array(human)/100, np.array(standard)/100):.4f}')
...
print('MLP Prior-trained:', mlp_prior_trained)
print('Human:', human)
print("\nR² values for NOT SimpleBoolean concepts (architectures comparison):")
print(f'R² LSTM Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(prior_trained)/100):.4f}')
print(f'R² Transformer Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(transformer_prior_trained)/100):.4f}')
print(f'R² MLP Prior-trained vs Human: {r2_score(np.array(human)/100, np.array(mlp_prior_trained)/100):.4f}')
...
print('MLP Standard:', mlp_standard)
print('Human:', human)
print("\nR² values for NOT SimpleBoolean concepts (standard architectures):")
print(f'R² LSTM Standard vs Human: {r2_score(np.array(human)/100, np.array(standard)/100):.4f}')
print(f'R² Transformer Standard vs Human: {r2_score(np.array(human)/100, np.array(transformer_standard)/100):.4f}')
print(f'R² MLP Standard vs Human: {r2_score(np.array(human)/100, np.array(mlp_standard)/100):.4f}')
...
# plt.legend(fontsize=16, loc='upper left')
plt.savefig('new_plots/avg_not_simpleboolean_concepts')
plt.show()
...
# plt.legend(fontsize=16, loc='upper left')
plt.savefig('new_plots/architectures_priortrained_not_simpleboolean_concepts.png')
plt.show()
...
# plt.legend(fontsize=16, loc='upper left')
plt.savefig('new_plots/architectures_standard_not_simpleboolean_concepts.png')
plt.show()